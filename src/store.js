...
import service from "@/services/WeatherService.js"; // service.js fetch data from API. We will have a look at it in the next step.
  ...
  mutations: { // change state from here
    UPDATE_WEATHER(state) {
      service
        ...
        //   console.warn(response); // and log it
        })
        .catch(error => { // if there was an error
            print(error)
        //   console.warn("There was an error:", error.response); // log it
